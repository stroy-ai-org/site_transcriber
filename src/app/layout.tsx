...
export const metadata: Metadata = {
  title: "Транскрибатор — транскрибация аудио и видео в текст | AI-бот в Max",
  description: "Транскрибация аудио и видео в текст онлайн. AI-бот для транскрибации совещаний, саммари встреч и протоколов с задачами — в мессенджере Max. Распознавание речи с таймкодами и спикерами.",
  keywords: "транскрибация, транскрибация аудио, транскрибация видео, транскрибация аудио в текст, транскрибация онлайн, транскрибация совещаний, AI транскрибатор, саммари встречи, протокол совещания, распознавание речи",
  openGraph: {
    title: "Транскрибатор — транскрибация аудио и видео в текст",
    description: "AI-бот для транскрибации аудио и видео в текст. Саммари, протоколы и глубокий анализ совещаний в мессенджере Max.",
